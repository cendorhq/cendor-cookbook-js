...
import { Block, type BlockDecision, Context, useCompressor } from '@cendor/contextkit';
...
const payload = entry.payload as CompressionPayload;
...
const restored = decision.handle.expand() as string;
