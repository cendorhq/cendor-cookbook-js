...
// (1) spend rows -> metric counters — a real OTel Meter, injected, no global provider needed.
// (@cendor/tokenguard >= 3.1.1: earlier versions mis-declared the counter type and this line
// needed a cast; the recipe pins the fixed shelf.)
