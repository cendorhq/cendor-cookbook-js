...
import { evaluateAsync, type Guardrail, judge, rules } from '@cendor/guardrails';
...
function makeRespond(client: ReturnType<typeof judgeClient>) {
 ...
 */
async function screen(rail: Guardrail, tool: string, args: Record<string, unknown>) {
...
function runSession(rail: Guardrail) {
