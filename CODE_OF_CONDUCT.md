...
— open this repository's [**Security** tab → **Report a
vulnerability**](https://github.com/cendorhq/cendor-cookbook/security/advisories/new) — which opens a
private report only the maintainers can see. (It is the reporting channel we have that is private by
construction; it is not a claim that a conduct report is a security issue.) All complaints will be
reviewed and investigated promptly and fairly. Community leaders are obligated to respect the privacy
